...
}},_onInputBlur:function(g){var f=a(this._element).find(".ruButton.ruBrowse");
f.css("border","0px dotted");
},_onInputFocus:function(g){var f=a(this._element).find(".ruButton.ruBrowse");
f.css("border","1px dotted");
},_onFocus:function(){var f=a(this._element).find(".ruFileInput");
var e=f[f.length-1];
if(e){e.focus();
...
e.appendChild(f);
return f;
},_createInput:function(f,e,g,i){var h=this.get_localization();
var j=h[f];
return a("<input>").attr({type:g,tabindex:i,value:j,"class":e})[0];
...
setTimeout(function(){h.deleteFileInputAt(e.index(),true);
},50);
...
x.style.zIndex=-1;
a(x).attr("tabindex","-1");
r.trigger("FilesSelected",u.initialRow,w.length);
...
if($telerik.isIE10Mode&&this.context.file.size==0){j.trigger("FileUploadFail",k,"IE10 browser does not support upload of 0 bytes size file");
...
}}},send:function(){var m=this.xhr,h=this,i=this.moduleContext.module;
...
m.upload.onprogress=function j(o){var q=h.context.row,r=q.id,n=h.context.progressData;
n.loaded=o.loaded;
...
if($telerik.isIE){a(v).keydown(function(y){if(y.keyCode==Sys.UI.Key.enter){y.preventDefault();
}});
...
}function e(){var u=a(d._createInput("","ruFileInput","file",d._tabIndex));
...
(function() {
    function loadHandler() {
        ...
        hf.value += ';;System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35:sv-SE:c7c66246-7597-47ee-87ae-ac254004a457:ea597d4b:b25378d2;Telerik.Web.UI, Version=2013.3.1114.45, Culture=neutral, PublicKeyToken=121fae78165ba3d4:sv-SE:9d967110-0dc5-4d20-a086-c7556058bb3c:16e4e7cd:b7778d6c:f7645509:24ee1bba:52af31a4';                                    
